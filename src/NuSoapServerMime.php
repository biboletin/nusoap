...
/**
 * Renamed from nusoap_server_mime to NuSoapServerMime
 *
...
use Biboletin\Nusoap\NuSoapServer;
...
class NuSoapServerMime extends NuSoapServer
{
     ...
     * Note: getHTTPBody must be called before this.
     *
     * @return mixed The HTTP content type charset for the current response.
     */
     ...
     */
    private function parseRequest(array $headers, string $data): mixed
    {
        $this->debuggger->debug('Entering parseRequest() for payload of length '
